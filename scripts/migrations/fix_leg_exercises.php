...
try {
    ...
    // Primero eliminar los ejercicios con valores de enum inválidos
    $invalidSecondaries = ['glutes', 'calves', 'adductors'];
    
    foreach ($invalidSecondaries as $invalid) {
        $conn->executeStatement("DELETE FROM exercises WHERE secondary_muscle_group = ?", [$invalid]);
        echo "🗑️ Eliminados ejercicios con secondary_muscle_group='$invalid'\n";
    }
    
    // Ahora reinsertar con valores válidos del enum
    $exercises = [
        // === PRINCIPIANTE - SENTADILLAS BÁSICAS ===
        ['Air Squat', 'beginner', 1, 'legs', 'core', 'Sentadilla con peso corporal. Pies a ancho de hombros, bajar controlando hasta que muslos estén paralelos o más abajo. Base de todas las sentadillas.', null],
        ...
        ['Box Squat', 'beginner', 1, 'legs', 'core', 'Sentadilla a caja/banco. Bajar hasta tocar el banco, subir. Control de profundidad y técnica.', null],
        ['Sit To Stand', 'beginner', 1, 'legs', 'core', 'Sentarse y levantarse de silla/banco. Movimiento funcional básico, control excéntrico al sentarse.', null],
        
        // === PRINCIPIANTE - ZANCADAS ===
        ['Stationary Lunge', 'beginner', 1, 'legs', 'core', 'Zancada estática. Un pie adelante, otro atrás, bajar y subir sin mover pies. Básico para equilibrio.', null],
        ['Reverse Lunge', 'beginner', 2, 'legs', 'core', 'Zancada hacia atrás. Dar paso atrás, bajar rodilla, volver. Menos impacto en rodilla que forward lunge.', null],
        ['Walking Lunge', 'beginner', 2, 'legs', 'core', 'Zancada caminando. Dar pasos largos alternando piernas. Coordinación y resistencia.', null],
        ['Side Lunge', 'beginner', 2, 'legs', 'core', 'Sentadilla lateral. Paso lateral, flexionar rodilla de esa pierna manteniendo la otra recta. Trabaja aductores.', null],
        ...
        ['Donkey Kick', 'beginner', 1, 'legs', 'core', 'Patada de burro. A cuatro patas, elevar talón hacia techo contrayendo glúteo. Aislamiento glúteo.', null],
        ...
        ['Cossack Squat', 'intermediate', 2, 'legs', 'core', 'Sentadilla cosaca. Pierna de trabajo flexionada lateralmente, otra extendida. Gran movilidad de cadera.', null],
        ...
        ['Bulgarian Split Squat', 'intermediate', 2, 'legs', 'core', 'Sentadilla búlgara. Pie trasero sobre banco, bajar con pierna delantera. Intenso cuádriceps y glúteos.', 'bancos_soportes'],
        ...
        ['Curtsy Lunge', 'intermediate', 2, 'legs', 'core', 'Zancada de reverencia. Cruzar pierna atrás en diagonal, trabaja glúteo medio.', null],
        
        // === INTERMEDIO - STEP UPS Y SALTOS ===
        ['Step Up', 'intermediate', 1, 'legs', 'core', 'Subida a banco. Subir con fuerza de una pierna, control al bajar. Funcional y potente.', 'bancos_soportes'],
        ['High Step Up', 'intermediate', 2, 'legs', 'core', 'Subida a banco alto. Mayor rango y dificultad que step up normal.', 'bancos_soportes'],
        ['Jump Squat', 'intermediate', 2, 'legs', 'core', 'Sentadilla con salto. Bajar en sentadilla, explotar hacia arriba con salto. Pliométrico básico.', null],
        ['Box Jump', 'intermediate', 2, 'legs', 'core', 'Salto a caja. Desde posición semiflexionada, saltar aterrizando sobre banco. Potencia explosiva.', 'bancos_soportes'],
        ...
        ['Depth Jump', 'expert', 3, 'legs', 'core', 'Salto desde altura. Caer de banco alto y inmediatamente saltar lo más alto posible. Reactividad.', 'bancos_soportes'],
